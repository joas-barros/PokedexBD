...
class PokemonService {
    ...
    public function save(){
        ...
        if (isset($input['pokedex']) && isset($input['nome']) && isset($input['habilidade1']) && isset($input['habilidade2']) && isset($input['habilidade3']) && isset($input['habilidade4']) && isset($input['level_min']) && isset($input['level_max']) && isset($input['hp_min']) && isset($input['hp_max']) && isset($input['attack_min']) && isset($input['attack_max']) && isset($input['defense_min']) && isset($input['defense_max']) && isset($input['sp_attack_min']) && isset($input['sp_attack_max']) && isset($input['sp_defense_min']) && isset($input['sp_defense_max']) && isset($input['velocidade_min']) && isset($input['velocidade_max']) && isset($input['sexo']) && isset($input['altura']) && isset($input['peso']) && isset($input['pokemonIMG'])){
            ...
            if ($pokedex && $habilidade1 && $habilidade2 && $habilidade3 && $habilidade4){
    ...
    public function update($id){
        ...
        if (isset($input['nome']) && isset($input['habilidade1']) && isset($input['habilidade2']) && isset($input['habilidade3']) && isset($input['habilidade4']) && isset($input['level_min']) && isset($input['level_max']) && isset($input['hp_min']) && isset($input['hp_max']) && isset($input['attack_min']) && isset($input['attack_max']) && isset($input['defense_min']) && isset($input['defense_max']) && isset($input['sp_attack_min']) && isset($input['sp_attack_max']) && isset($input['sp_defense_min']) && isset($input['sp_defense_max']) && isset($input['velocidade_min']) && isset($input['velocidade_max']) && isset($input['sexo']) && isset($input['altura']) && isset($input['peso']) && isset($input['pokemonIMG'])){
