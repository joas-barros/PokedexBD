...
class Fraqueza implements JsonSerializable {
    ...
    public function jsonSerialize(): array {
        return [
            ...
            'fraqueza1' => $this->fraqueza1->jsonSerialize(),
            'fraqueza2' => $this->fraqueza2->jsonSerialize(),
            'fraqueza3' => $this->fraqueza3->jsonSerialize(),
            'fraqueza4' => $this->fraqueza4->jsonSerialize(),
            'fraqueza5' => $this->fraqueza5->jsonSerialize()
        ];
    }
}
?>