...
CREATE TABLE HABILIDADE_PASSIVA(
...
CONSTRAINT FK_POKEMON_HABILIDADE_1 FOREIGN KEY (Pokemon_Habilidade_1) REFERENCES HABILIDADE_PASSIVA(HABILIDADE_ID) ON DELETE RESTRICT ON UPDATE CASCADE,
CONSTRAINT FK_POKEMON_HABILIDADE_2 FOREIGN KEY (Pokemon_Habilidade_2) REFERENCES HABILIDADE_PASSIVA(HABILIDADE_ID) ON DELETE RESTRICT ON UPDATE CASCADE,
CONSTRAINT FK_POKEMON_HABILIDADE_3 FOREIGN KEY (Pokemon_Habilidade_3) REFERENCES HABILIDADE_PASSIVA(HABILIDADE_ID) ON DELETE RESTRICT ON UPDATE CASCADE,
CONSTRAINT FK_POKEMON_HABILIDADE_4 FOREIGN KEY (Pokemon_Habilidade_4) REFERENCES HABILIDADE_PASSIVA(HABILIDADE_ID) ON DELETE RESTRICT ON UPDATE CASCADE,
...
Pokemon_Level INT,
CONSTRAINT FK_POKEMON_ID FOREIGN KEY(Pokemon_ID) REFERENCES POKEDEX(POKEDEX_NUM) ON DELETE RESTRICT ON UPDATE CASCADE,
CONSTRAINT FK_TREINADOR_ID FOREIGN KEY(Treinador_ID) REFERENCES TREINADOR(TREINADOR_ID) ON DELETE CASCADE ON UPDATE CASCADE,
PRIMARY KEY(Pokemon_ID, Treinador_ID)
);
